...
types:
  note:
    seq:
      ...
      - id: sound_generation_mode
        type: u1
        enum: mpc2000pgm_write::sound_generation_mode
      ...
      - id: voice_overlap_mode
        type: u1
        enum: mpc2000pgm_write::voice_overlap_mode
      - id: mute_assign_1
        type: u1
      - id: mute_assign_2
        type: u1
      ...
      - id: decay_mode
        type: u1
        enum: mpc2000pgm_write::decay_mode
      - id: cutoff
        type: u1
      - id: resonance
        type: u1
      ...
      - id: slider_parameter
        type: u1
        enum: mpc2000pgm_write::slider_parameter
  ...
  drum:
    seq:
      - id: pad_mixers
        type: mpc2000pgm_write::pad_mixer
        repeat: expr
        repeat-expr: 64
      - size: 2
